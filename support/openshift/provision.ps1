...
Function Usage() {
  ...
  Write-Output " $scriptName -command setup -demo rhdm7-insurance -project-suffix s40d"
  Write-Output ""
  ...
  Write-Output ""
  Write-Output "DEMOS:"
  Write-Output "   rhdm7-insurance          Red Hat Decision Manager Insurance Pricing DMN demo"
  Write-Output ""
