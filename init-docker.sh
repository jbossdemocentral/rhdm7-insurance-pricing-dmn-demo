...
docker build --no-cache -t jbossdemocentral/rhdm7-insurance-pricing-dmn-demo .
...
echo "=                                                                               ="
echo "=  docker run -it -p 8080:8080 -p 9990:9990 jbossdemocentral/rhdm7-insurance-pricing-dmn-demo    ="
echo "=                                                                               ="
